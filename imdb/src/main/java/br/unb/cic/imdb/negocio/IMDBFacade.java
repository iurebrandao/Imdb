...
/**
 * Classe de fachada (Facade class) que vai servir de comunicacao entre a camada
 * de apresentacao (ui) e a camada de negocio. Caso se torne excessivamente
 * complexa, essa classe deve ser sub-dividida.
 * 
 * @author rbonifacio
 */
