...
/**
 * Implementacao do DAOGenero em memoria. Util particularmente para as situacoes
 * em que queremos testar individualmente as classes, sem a necessidade de
...
public class DAOGeneroMemoria implements DAOGenero {
	...
	public Genero recuperaPorTitulo(String titulo) {
		...
		// List<Genero> res = generos.stream().filter(g ->
		// g.getTitulo().equals(titulo)).collect(Collectors.toList());
